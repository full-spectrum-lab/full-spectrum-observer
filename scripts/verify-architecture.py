...
# evidence/ folder (backward compatible). Architecture static report goes to ig2/.
...
path=EVIDENCE_ROOT/'ig2/architecture-static.json'; path.parent.mkdir(parents=True,exist_ok=True); path.write_text(json.dumps(out,indent=2),encoding='utf-8')
